...
_Last updated: May 19, 2026 | Day 51 of 90_
...
> 📡 **CURRENT SIGNAL** (2026-05-19): **BULLISH** | ⚡ Price Override Active (+6.1% above MA50)  
> Fast: MA10 $738.33 | MA30 $715.9  
> Slow: MA20 $726.82 | MA50 $692.2  
...
| Day 51 | 2026-05-19 | $734.48 | Long 55 SPY (T8) | +$649.57 | +1.634% | $100,667.43 |
...
| Day 51 | 2026-05-19 | $100,667.43 | $108,583.39 | +0.6674% | +8.583% | **-7.916%** |
...
| Day 51 | 2026-05-19 | $734.48 | +$680.44 | -$662.58 | Position open |
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $726.82 vs MA50 $692.2). Momentum: RECOVERING. Unrealized P&L: +1.50% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $726.82 vs MA50 $692.2). Momentum: RECOVERING. Unrealized P&L: +1.32% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $726.82 vs MA50 $692.2). Momentum: RECOVERING. Unrealized P&L: +1.21% from entry. No exit triggered.
...
**What I did today:** System exited the position. Realized P&L locked at $+17.86. Regime: BULL (MA20 $726.82 vs MA50 $692.2). Fast signal (MA10/MA30): bullish. Monitoring for re-entry on next fast golden cross.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $726.82 vs MA50 $692.2). Momentum: RECOVERING. Unrealized P&L: +0.29% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $726.82 vs MA50 $692.2). Momentum: RECOVERING. Unrealized P&L: +0.20% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $726.82 vs MA50 $692.2). Momentum: RECOVERING. Unrealized P&L: +0.38% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $726.82 vs MA50 $692.2). Momentum: RECOVERING. Unrealized P&L: +0.55% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $726.82 vs MA50 $692.2). Momentum: RECOVERING. Unrealized P&L: +0.06% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $726.82 vs MA50 $692.2). Momentum: RECOVERING. Unrealized P&L: -0.30% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $726.82 vs MA50 $692.2). Momentum: RECOVERING. Unrealized P&L: -0.63% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $726.82 vs MA50 $692.2). Momentum: RECOVERING. Unrealized P&L: +0.14% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $726.82 vs MA50 $692.2). Momentum: RECOVERING. Unrealized P&L: +1.54% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $726.82 vs MA50 $692.2). Momentum: RECOVERING. Unrealized P&L: +1.23% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $726.82 vs MA50 $692.2). Momentum: RECOVERING. Unrealized P&L: +2.06% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $726.82 vs MA50 $692.2). Momentum: RECOVERING. Unrealized P&L: +2.29% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $726.82 vs MA50 $692.2). Momentum: RECOVERING. Unrealized P&L: +2.15% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $726.82 vs MA50 $692.2). Momentum: RECOVERING. Unrealized P&L: +2.72% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $726.82 vs MA50 $692.2). Momentum: RECOVERING. Unrealized P&L: +3.52% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $726.82 vs MA50 $692.2). Momentum: RECOVERING. Unrealized P&L: +2.27% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $726.82 vs MA50 $692.2). Momentum: RECOVERING. Unrealized P&L: +2.18% from entry. No exit triggered.
...
| Entry (Alpaca fill) | $666.436/share |
| Close price | $734.48 |
| Unrealized P&L | +$649.57 |
| P&L % | +1.634% |
| Portfolio value | $100,667.43 |
| Benchmark value | $108,583.39 |
| Alpha (cumulative) | -7.916% |
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $726.82 vs MA50 $692.2). Momentum: RECOVERING. Unrealized P&L: +1.63% from entry. No exit triggered.
...
---
_Day 51 of 90 · Alpaca equity: $100,672.89 · Cumulative alpha vs SPY: -7.916%_