...
_Last updated: July 10, 2026 | Day 86 of 90_
...
> 📡 **CURRENT SIGNAL** (2026-07-10): **BEARISH**  
> Fast: MA10 $743.77 | MA30 $744.03  
> Slow: MA20 $741.76 | MA50 $739.0  
...
**Total trades:** 9 | **Closed:** 9 | **Open:** No | **Cumulative Realized P&L:** +$1188.82
...
| Alpaca equity | $101,190.39 |
| Alpaca cash | $101,190.39 |
...
| Day 86 | 2026-07-10 | $752.75 | FLAT | — | — | $101,188.82 |
...
| Day 86 | 2026-07-10 | $101,188.82 | $111,571.40 | +1.1888% | +11.571% | **-10.382%** |
...
| Day 86 | 2026-07-10 | $752.75 | +$863.14 | +$325.68 | Flat saved **+$325.68** vs holding |
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $741.76 vs MA50 $739.0). Momentum: RECOVERING. Unrealized P&L: +1.24% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $741.76 vs MA50 $739.0). Momentum: RECOVERING. Unrealized P&L: +1.06% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $741.76 vs MA50 $739.0). Momentum: RECOVERING. Unrealized P&L: +0.94% from entry. No exit triggered.
...
**What I did today:** System exited the position. Realized P&L locked at $+1188.82. Regime: BULL (MA20 $741.76 vs MA50 $739.0). Fast signal (MA10/MA30): bearish. Monitoring for re-entry on next fast golden cross.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $741.76 vs MA50 $739.0). Momentum: RECOVERING. Unrealized P&L: +0.03% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $741.76 vs MA50 $739.0). Momentum: RECOVERING. Unrealized P&L: -0.06% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $741.76 vs MA50 $739.0). Momentum: RECOVERING. Unrealized P&L: +0.12% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $741.76 vs MA50 $739.0). Momentum: RECOVERING. Unrealized P&L: +0.29% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $741.76 vs MA50 $739.0). Momentum: RECOVERING. Unrealized P&L: -0.20% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $741.76 vs MA50 $739.0). Momentum: RECOVERING. Unrealized P&L: -0.56% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $741.76 vs MA50 $739.0). Momentum: RECOVERING. Unrealized P&L: -0.89% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $741.76 vs MA50 $739.0). Momentum: RECOVERING. Unrealized P&L: -0.11% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $741.76 vs MA50 $739.0). Momentum: RECOVERING. Unrealized P&L: +1.27% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $741.76 vs MA50 $739.0). Momentum: RECOVERING. Unrealized P&L: +0.97% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $741.76 vs MA50 $739.0). Momentum: RECOVERING. Unrealized P&L: +1.80% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $741.76 vs MA50 $739.0). Momentum: RECOVERING. Unrealized P&L: +2.02% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $741.76 vs MA50 $739.0). Momentum: RECOVERING. Unrealized P&L: +1.89% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $741.76 vs MA50 $739.0). Momentum: RECOVERING. Unrealized P&L: +2.45% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $741.76 vs MA50 $739.0). Momentum: RECOVERING. Unrealized P&L: +3.25% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $741.76 vs MA50 $739.0). Momentum: RECOVERING. Unrealized P&L: +2.01% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $741.76 vs MA50 $739.0). Momentum: RECOVERING. Unrealized P&L: +1.91% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $741.76 vs MA50 $739.0). Momentum: RECOVERING. Unrealized P&L: +1.28% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $741.76 vs MA50 $739.0). Momentum: RECOVERING. Unrealized P&L: +2.32% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $741.76 vs MA50 $739.0). Momentum: RECOVERING. Unrealized P&L: +2.51% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $741.76 vs MA50 $739.0). Momentum: RECOVERING. Unrealized P&L: +2.92% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $741.76 vs MA50 $739.0). Momentum: RECOVERING. Unrealized P&L: +3.58% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $741.76 vs MA50 $739.0). Momentum: RECOVERING. Unrealized P&L: +3.60% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $741.76 vs MA50 $739.0). Momentum: RECOVERING. Unrealized P&L: +4.16% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $741.76 vs MA50 $739.0). Momentum: RECOVERING. Unrealized P&L: +4.39% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $741.76 vs MA50 $739.0). Momentum: RECOVERING. Unrealized P&L: +4.68% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $741.76 vs MA50 $739.0). Momentum: RECOVERING. Unrealized P&L: +4.82% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $741.76 vs MA50 $739.0). Momentum: RECOVERING. Unrealized P&L: +4.09% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $741.76 vs MA50 $739.0). Momentum: RECOVERING. Unrealized P&L: +4.48% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $741.76 vs MA50 $739.0). Momentum: RECOVERING. Unrealized P&L: +1.78% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $741.76 vs MA50 $739.0). Momentum: RECOVERING. Unrealized P&L: +2.03% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $741.76 vs MA50 $739.0). Momentum: RECOVERING. Unrealized P&L: +1.73% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $741.76 vs MA50 $739.0). Momentum: RECOVERING. Unrealized P&L: +0.14% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $741.76 vs MA50 $739.0). Momentum: RECOVERING. Unrealized P&L: +1.81% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $741.76 vs MA50 $739.0). Momentum: RECOVERING. Unrealized P&L: +2.37% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $741.76 vs MA50 $739.0). Momentum: RECOVERING. Unrealized P&L: +4.17% from entry. No exit triggered.
...
| Close price | $752.75 |
| Realized P&L (locked) | +$1188.82 |
| Reference if held | +$863.14 |
| Signal saved | +$325.68 |
| Portfolio value | $101,188.82 |
| Benchmark value | $111,571.40 |
| Alpha (cumulative) | -10.382% |
...
---
_Day 86 of 90 · Alpaca equity: $101,190.39 · Cumulative alpha vs SPY: -10.382%_