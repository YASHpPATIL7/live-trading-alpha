...
> Fast: MA10 $751.83 | MA30 $738.33  
> Slow: MA20 $746.37 | MA50 $715.39  
...
| Day 65 | 2026-06-09 | $726.67 | Long 55 SPY (T8) | +$220.02 | +0.554% | $100,237.88 |
...
| Day 65 | 2026-06-09 | $100,237.88 | $107,428.79 | +0.2379% | +7.429% | **-7.191%** |
...
| Day 65 | 2026-06-09 | $726.67 | +$602.34 | -$584.48 | Position open |
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $746.37 vs MA50 $715.39). Momentum: RECOVERING. Unrealized P&L: +1.50% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $746.37 vs MA50 $715.39). Momentum: RECOVERING. Unrealized P&L: +1.32% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $746.37 vs MA50 $715.39). Momentum: RECOVERING. Unrealized P&L: +1.21% from entry. No exit triggered.
...
**What I did today:** System exited the position. Realized P&L locked at $+17.86. Regime: BULL (MA20 $746.37 vs MA50 $715.39). Fast signal (MA10/MA30): bullish. Monitoring for re-entry on next fast golden cross.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $746.37 vs MA50 $715.39). Momentum: RECOVERING. Unrealized P&L: +0.29% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $746.37 vs MA50 $715.39). Momentum: RECOVERING. Unrealized P&L: +0.20% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $746.37 vs MA50 $715.39). Momentum: RECOVERING. Unrealized P&L: +0.38% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $746.37 vs MA50 $715.39). Momentum: RECOVERING. Unrealized P&L: +0.55% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $746.37 vs MA50 $715.39). Momentum: RECOVERING. Unrealized P&L: +0.06% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $746.37 vs MA50 $715.39). Momentum: RECOVERING. Unrealized P&L: -0.30% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $746.37 vs MA50 $715.39). Momentum: RECOVERING. Unrealized P&L: -0.63% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $746.37 vs MA50 $715.39). Momentum: RECOVERING. Unrealized P&L: +0.14% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $746.37 vs MA50 $715.39). Momentum: RECOVERING. Unrealized P&L: +1.54% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $746.37 vs MA50 $715.39). Momentum: RECOVERING. Unrealized P&L: +1.23% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $746.37 vs MA50 $715.39). Momentum: RECOVERING. Unrealized P&L: +2.06% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $746.37 vs MA50 $715.39). Momentum: RECOVERING. Unrealized P&L: +2.29% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $746.37 vs MA50 $715.39). Momentum: RECOVERING. Unrealized P&L: +2.15% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $746.37 vs MA50 $715.39). Momentum: RECOVERING. Unrealized P&L: +2.72% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $746.37 vs MA50 $715.39). Momentum: RECOVERING. Unrealized P&L: +3.52% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $746.37 vs MA50 $715.39). Momentum: RECOVERING. Unrealized P&L: +2.27% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $746.37 vs MA50 $715.39). Momentum: RECOVERING. Unrealized P&L: +2.18% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $746.37 vs MA50 $715.39). Momentum: RECOVERING. Unrealized P&L: +2.58% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $746.37 vs MA50 $715.39). Momentum: RECOVERING. Unrealized P&L: +2.77% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $746.37 vs MA50 $715.39). Momentum: RECOVERING. Unrealized P&L: +3.18% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $746.37 vs MA50 $715.39). Momentum: RECOVERING. Unrealized P&L: +3.85% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $746.37 vs MA50 $715.39). Momentum: RECOVERING. Unrealized P&L: +3.86% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $746.37 vs MA50 $715.39). Momentum: RECOVERING. Unrealized P&L: +4.43% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $746.37 vs MA50 $715.39). Momentum: RECOVERING. Unrealized P&L: +4.66% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $746.37 vs MA50 $715.39). Momentum: RECOVERING. Unrealized P&L: +4.95% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $746.37 vs MA50 $715.39). Momentum: RECOVERING. Unrealized P&L: +5.09% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $746.37 vs MA50 $715.39). Momentum: RECOVERING. Unrealized P&L: +4.36% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $746.37 vs MA50 $715.39). Momentum: RECOVERING. Unrealized P&L: +4.75% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $746.37 vs MA50 $715.39). Momentum: RECOVERING. Unrealized P&L: +2.04% from entry. No exit triggered.
...
| Entry (Alpaca fill) | $666.436/share |
| Close price | $726.67 |
| Unrealized P&L | +$220.02 |
| P&L % | +0.554% |
| Portfolio value | $100,237.88 |
| Benchmark value | $107,428.79 |
| Alpha (cumulative) | -7.191% |
...
---
_Day 65 of 90 · Alpaca equity: $100,251.59 · Cumulative alpha vs SPY: -7.191%_