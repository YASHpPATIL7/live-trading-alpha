...
_Last updated: August 04, 2026 | Day 74 of 90_
...
> 📡 **CURRENT SIGNAL** (2026-08-04): **BEARISH**  
> Fast: MA10 $742.86 | MA30 $744.15  
> Slow: MA20 $746.01 | MA50 $744.59  
...
| Day 74 | 2026-08-04 | $768.27 | FLAT | — | — | $99,933.56 |
...
| Day 74 | 2026-08-04 | $99,933.56 | $108,670.79 | -0.0664% | +8.671% | **-8.737%** |
...
| Day 74 | 2026-08-04 | $768.27 | +$3445.38 | -$3511.82 | Holding would have been **$3511.82** better — honest entry |
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $746.01 vs MA50 $744.59). Momentum: RECOVERING. Unrealized P&L: +0.03% from entry. No exit triggered.
...
**What I did today:** System exited the position. Realized P&L locked at $-66.44. Regime: BULL (MA20 $746.01 vs MA50 $744.59). Fast signal (MA10/MA30): bearish. Monitoring for re-entry on next fast golden cross.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $746.01 vs MA50 $744.59). Momentum: RECOVERING. Unrealized P&L: -0.06% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $746.01 vs MA50 $744.59). Momentum: RECOVERING. Unrealized P&L: +0.12% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $746.01 vs MA50 $744.59). Momentum: RECOVERING. Unrealized P&L: +0.29% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $746.01 vs MA50 $744.59). Momentum: RECOVERING. Unrealized P&L: -0.20% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $746.01 vs MA50 $744.59). Momentum: RECOVERING. Unrealized P&L: -0.56% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $746.01 vs MA50 $744.59). Momentum: RECOVERING. Unrealized P&L: -0.89% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $746.01 vs MA50 $744.59). Momentum: RECOVERING. Unrealized P&L: -0.11% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $746.01 vs MA50 $744.59). Momentum: RECOVERING. Unrealized P&L: +1.27% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $746.01 vs MA50 $744.59). Momentum: RECOVERING. Unrealized P&L: +0.97% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $746.01 vs MA50 $744.59). Momentum: RECOVERING. Unrealized P&L: +1.80% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $746.01 vs MA50 $744.59). Momentum: RECOVERING. Unrealized P&L: +2.02% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $746.01 vs MA50 $744.59). Momentum: RECOVERING. Unrealized P&L: +1.89% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $746.01 vs MA50 $744.59). Momentum: RECOVERING. Unrealized P&L: +2.45% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $746.01 vs MA50 $744.59). Momentum: RECOVERING. Unrealized P&L: +3.25% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $746.01 vs MA50 $744.59). Momentum: RECOVERING. Unrealized P&L: +2.01% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $746.01 vs MA50 $744.59). Momentum: RECOVERING. Unrealized P&L: +1.91% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $746.01 vs MA50 $744.59). Momentum: RECOVERING. Unrealized P&L: +1.28% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $746.01 vs MA50 $744.59). Momentum: RECOVERING. Unrealized P&L: +2.32% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $746.01 vs MA50 $744.59). Momentum: RECOVERING. Unrealized P&L: +2.51% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $746.01 vs MA50 $744.59). Momentum: RECOVERING. Unrealized P&L: +2.92% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $746.01 vs MA50 $744.59). Momentum: RECOVERING. Unrealized P&L: +3.58% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $746.01 vs MA50 $744.59). Momentum: RECOVERING. Unrealized P&L: +3.60% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $746.01 vs MA50 $744.59). Momentum: RECOVERING. Unrealized P&L: +4.16% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $746.01 vs MA50 $744.59). Momentum: RECOVERING. Unrealized P&L: +4.39% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $746.01 vs MA50 $744.59). Momentum: RECOVERING. Unrealized P&L: +4.68% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $746.01 vs MA50 $744.59). Momentum: RECOVERING. Unrealized P&L: +4.82% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $746.01 vs MA50 $744.59). Momentum: RECOVERING. Unrealized P&L: +4.09% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $746.01 vs MA50 $744.59). Momentum: RECOVERING. Unrealized P&L: +4.48% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $746.01 vs MA50 $744.59). Momentum: RECOVERING. Unrealized P&L: +1.78% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $746.01 vs MA50 $744.59). Momentum: RECOVERING. Unrealized P&L: +2.03% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $746.01 vs MA50 $744.59). Momentum: RECOVERING. Unrealized P&L: +1.73% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $746.01 vs MA50 $744.59). Momentum: RECOVERING. Unrealized P&L: +0.14% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $746.01 vs MA50 $744.59). Momentum: RECOVERING. Unrealized P&L: +1.81% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $746.01 vs MA50 $744.59). Momentum: RECOVERING. Unrealized P&L: +2.37% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $746.01 vs MA50 $744.59). Momentum: RECOVERING. Unrealized P&L: +4.17% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $746.01 vs MA50 $744.59). Momentum: RECOVERING. Unrealized P&L: +0.07% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BEARISH. Regime: BULL (MA20 $746.01 vs MA50 $744.59). Momentum: RECOVERING. Unrealized P&L: -0.02% from entry. No exit triggered.
...
| Close price | $768.27 |
| Realized P&L (locked) | -$66.44 |
| Reference if held | +$3445.38 |
| Signal saved | -$3511.82 |
| Portfolio value | $99,933.56 |
| Benchmark value | $108,670.79 |
| Alpha (cumulative) | -8.737% |
...
---
_Day 74 of 90 · Alpaca equity: $99,964.59 · Cumulative alpha vs SPY: -8.737%_