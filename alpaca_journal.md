...
_Last updated: May 15, 2026 | Day 49 of 90_
...
> 📡 **CURRENT SIGNAL** (2026-05-15): **BULLISH** | ⚡ Price Override Active (+7.5% above MA50)  
> Fast: MA10 $735.45 | MA30 $710.82  
> Slow: MA20 $723.93 | MA50 $689.73  
...
| Day 49 | 2026-05-15 | $741.55 | Long 55 SPY (T8) | +$1038.42 | +2.613% | $101,056.28 |
...
| Day 49 | 2026-05-15 | $101,056.28 | $109,628.60 | +1.0563% | +9.629% | **-8.573%** |
...
| Day 49 | 2026-05-15 | $741.55 | +$751.14 | -$733.28 | Position open |
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $723.93 vs MA50 $689.73). Momentum: STRONG. Unrealized P&L: +1.50% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $723.93 vs MA50 $689.73). Momentum: STRONG. Unrealized P&L: +1.32% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $723.93 vs MA50 $689.73). Momentum: STRONG. Unrealized P&L: +1.21% from entry. No exit triggered.
...
**What I did today:** System exited the position. Realized P&L locked at $+17.86. Regime: BULL (MA20 $723.93 vs MA50 $689.73). Fast signal (MA10/MA30): bullish. Monitoring for re-entry on next fast golden cross.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $723.93 vs MA50 $689.73). Momentum: STRONG. Unrealized P&L: +0.29% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $723.93 vs MA50 $689.73). Momentum: STRONG. Unrealized P&L: +0.20% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $723.93 vs MA50 $689.73). Momentum: STRONG. Unrealized P&L: +0.38% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $723.93 vs MA50 $689.73). Momentum: STRONG. Unrealized P&L: +0.55% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $723.93 vs MA50 $689.73). Momentum: STRONG. Unrealized P&L: +0.06% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $723.93 vs MA50 $689.73). Momentum: STRONG. Unrealized P&L: -0.30% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $723.93 vs MA50 $689.73). Momentum: STRONG. Unrealized P&L: -0.63% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $723.93 vs MA50 $689.73). Momentum: STRONG. Unrealized P&L: +0.14% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $723.93 vs MA50 $689.73). Momentum: STRONG. Unrealized P&L: +1.54% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $723.93 vs MA50 $689.73). Momentum: STRONG. Unrealized P&L: +1.23% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $723.93 vs MA50 $689.73). Momentum: STRONG. Unrealized P&L: +2.06% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $723.93 vs MA50 $689.73). Momentum: STRONG. Unrealized P&L: +2.29% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $723.93 vs MA50 $689.73). Momentum: STRONG. Unrealized P&L: +2.15% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $723.93 vs MA50 $689.73). Momentum: STRONG. Unrealized P&L: +2.72% from entry. No exit triggered.
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $723.93 vs MA50 $689.73). Momentum: STRONG. Unrealized P&L: +3.52% from entry. No exit triggered.
...
| Entry (Alpaca fill) | $666.436/share |
| Close price | $741.55 |
| Unrealized P&L | +$1038.42 |
| P&L % | +2.613% |
| Portfolio value | $101,056.28 |
| Benchmark value | $109,628.60 |
| Alpha (cumulative) | -8.573% |
...
**What I did today:** System held long SPY. Fast signal remained BULLISH. Regime: BULL (MA20 $723.93 vs MA50 $689.73). Momentum: STRONG. Unrealized P&L: +2.61% from entry. No exit triggered.
...
---
_Day 49 of 90 · Alpaca equity: $101,073.02 · Cumulative alpha vs SPY: -8.573%_